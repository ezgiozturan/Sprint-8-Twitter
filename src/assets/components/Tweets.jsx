const tweets = [
  {
    ...
    content:
      "Bir zamanlar, Zımbırtı adında bir şehirde yaşayan Bobik adında bir patates vardı. Bobik, kendini diğer patateslerden çok farklı hissediyordu çünkü o bir uzay patatesiydi. Bir gün, Bobik uzaya gitmeye karar verdi. Ancak, patatesler uzay gemisi kullanamazdı, bu yüzden Bobik bir uzay roketi inşa etmeye başladı.",
  },
  {
    id: 2,
    isim: "Obi-Wan Kenobi",
    ...
    content:
      "Her zaman bir umut vardır. Güç sizi her daim korusun. #MayTheForceBeWithYou",
  },
  {
    id: 3,
    isim: "Küçük Prens",
    ...
    content:
      "Bir insanı tanımak için onun sözlerine değil, eylemlerine bak. Gözlerinle göremediğin şeylerin aslında ne kadar önemli olduğunu fark edeceksin. Sevgi ve dostluk her şeyden önce gelir. 🌟 #KüçükPrens #HayatınAnlamı #KalpGözleriyleBak",
  },
  {
    id: 4,
    isim: "Mehmet Demir",
